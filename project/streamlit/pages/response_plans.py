...
def response_plans():
    ...
    st.write("This is the response plans page")
    ...
    with st.container():
        ...
        with col1:
            show_pie("Response plan",'The number of risks for the Response plan')
        
        with col2:
            show_pie("Response plan officer",'The number of risks for the Response plan officer')
    ...
    with st.container():
        ...
        with col1:
            fig = plt.subplot()
            sn.countplot(x="Procedure type", data=df)
            st.pyplot(fig.figure)
            plt.close()
